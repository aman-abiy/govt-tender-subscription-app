  ...
  Widget build(BuildContext context) {
    return Consumer<SearchProvider>(
      builder: (context, searchProvider, child) {
        ...
        Set<String> intersection = searchProvider.searchCategories.toSet().intersection(widget.category.children.map((e) => e.id).toSet());
        ...
        return CheckboxListTile(
          ...
          onChanged: (bool isSelected) {
              if(isSelected) {
                ...
                searchProvider.addSearchCategory(ids: widget.category.children.map((e) => e.id).toList());
              } else {
                searchProvider.removeSearchCategory(id: widget.category.id, ids: widget.category.children.map((e) => e.id).toList());
              }
          },
